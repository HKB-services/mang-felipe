      ...
      <div className="mx-auto max-w-6xl">
        <div className="max-w-2xl">
          ...
          <p className="mt-5 max-w-xl text-base leading-7 text-[#3f5b4f] sm:text-lg dark:text-emerald-50/75">
            ...
            bilao, our family of brands brings good food to every kind of table.
          </p>
        </div>

        <article className="mt-12 overflow-hidden rounded-[2rem] bg-[#103d2d] text-white shadow-xl shadow-emerald-950/15 sm:mt-14 lg:grid lg:grid-cols-[1.12fr_0.88fr]">
              ...
              >
                ...
                <div className="relative px-6 pt-0 pb-7 sm:px-8 sm:pb-8">
                  <div className="-mt-9 flex items-end justify-between gap-4">
                    ...
                    />
                    <span className={`mb-2 h-1.5 w-14 rounded-full ${styles.rule}`} />
                  </div>
                  <p className={`mt-5 text-xs font-semibold tracking-[0.16em] uppercase ${styles.label}`}>
                    {brand.tagline}
                  </p>
        ...
        <div className="mt-10 flex flex-col gap-4 border-t border-[#103d2d]/15 pt-7 sm:flex-row sm:items-center sm:justify-between dark:border-white/15">
          <p className="text-sm text-[#3f5b4f] dark:text-emerald-50/75">
            Meet brands, places, and stories behind Happy Moments Food Corporation.
          </p>
          <Link
            href={ROUTES.HISTORY}
